...
Goal: simulate callers driving the same prompt + tools at text speed, a judge scores each against criteria, and you write results.json. Text-speed lets you run 25 scenarios in seconds and iterate all afternoon.
...
Create an "EVALUATION_TUTORIAL.md" with step-by-step clear simple instructions on how to run the eval_runner.py and what to look for in the output.